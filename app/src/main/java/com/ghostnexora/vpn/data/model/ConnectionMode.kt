...
enum class ConnectionMode(
    ...
    SSL_SNI(
        ...
        label = "SSH + SSL",
        family = "ssh",
        description = "SSH encapsulado en TLS con política SNI estricta o compatible con HTTP Custom.",
        usesTls = true,
        requiresSni = true,
    ...
    SSH_PAYLOAD_SSL(
        ...
        family = "ssh",
        description = "TLS con SNI estricto o compatible, payload HTTP y sesión SSH cifrada.",
        usesTls = true,
        requiresSni = true,
        requiresPayload = true,
    ...
    SSH_PAYLOAD_PROXY_SSL(
        ...
        family = "ssh",
        description = "Proxy, payload, TLS con política SNI seleccionable y SSH en una única cadena.",
        usesTls = true,
        requiresSni = true,
        requiresProxy = true,
        requiresPayload = true,
