...
/** Public handle owned by the Java VPN service for one active tunnel runtime. */
public final class VpnTunnelRuntime {
    private final ConnectionMode mode;
    private final SshTunnelHandle sshHandle;
    private final long verifiedLatencyMs;

    VpnTunnelRuntime(ConnectionMode mode, SshTunnelHandle sshHandle, long verifiedLatencyMs) {
        this.mode = mode;
